---
title: "【Endfield】オペレーターペリカの連携技による感電効果に関する検証"
...
アークナイツ：エンドフィールド（endfield）におけるオペレーター「ペリカ」の連携技が、敵に付与する「感電」状態の**被アーツダメージ増加倍率**について、「潜在04：長期導流」と「アーツ強度」のシナジーを実測データから明らかにします。
